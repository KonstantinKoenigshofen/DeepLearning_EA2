async function main() {
    ...
    */
    ...
    const cleanModel = await getOrTrainModel('cleanModel', trainData, testData, 50);
    ...
    */
    ...
    const bestModel = await getOrTrainModel('bestFitModel', noisyTrainData, noisyTestData, 50);
